    ...
    <body class="text-center">
        <div class="machine">
            ...
            <div class="bets d-flex justify-content-around my-4">
                ...
                <button id="bet-15" type="button" class="btn btn-info">$15</button>
                <button id="bet-20" type="button" class="btn btn-info">$20</button>
            </div>
            <button id="spin" type="button" class="btn btn mb-3 px-4 disabled">Spin</button>
        </div>
